    ...
    render(){
        return(
           <React.Fragment>
            <Carousel>
            <Carousel.Item >
                <img width={1500} height={1000} alt="London Hero" src="../images/london_hero.jpg" />
                <Carousel.Caption>
                <h3>London</h3>
            ...
            <Carousel.Item>
                <img width={1500} height={1000} alt="San Francisco Hero" src="../images/sanfrancisco_hero.jpg" />
                <Carousel.Caption>
                <h3>San Francisco</h3>
            ...
            <Carousel.Item>
                <img width={1500} height={1000} alt="Seattle Hero" src="../images/seattle-hero.jpg" />
                <Carousel.Caption>
                <h3>Seatle</h3>
            ...
            <Carousel.Item>
                <img width={1500} height={1000} alt="Sydney Hero" src="../images/sydney_hero.jpg" />
                <Carousel.Caption>
                <h3>Sydney</h3>
