...
class UserPostList extends Component{
    ...
    handleEditShow=(e)=>{
        this.setState({
            editPostShow: true, 
            postTitle: e.target.parentNode.firstChild.innerHTML, 
            postBody: e.target.parentNode.firstChild.nextSibling.innerHTML, 
    ...
    handleEditSubmit=(e)=>{
        ...
        axios.post(`http://localhost:3001/post/edit/${postID}`, {
            title: e.target.parentNode.parentNode.firstChild.firstChild.nextSibling.value,
            body: e.target.parentNode.parentNode.firstChild.nextSibling.firstChild.nextSibling.value
        }).then((data)=>{
